...
export class AssetsApi {
  ...
  public async getAssetById(
    ...
    const localVarPath =
      this.basePath + '/assets/{asset_id}'.replace('{' + 'asset_id' + '}', encodeURIComponent(String(assetId)))
  ...
  public async getAssetBySymbol(
    ...
    const localVarPath =
      this.basePath + '/assets/{symbol}'.replace('{' + 'symbol' + '}', encodeURIComponent(String(symbol)))
    const localVarQueryParameters: any = {}
    const localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders)
    const localVarFormParams: any = {}
  ...
  public async getAssets(
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: Array<AssetResource> }> {
