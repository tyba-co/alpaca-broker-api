...
export class DocumentsApi {
  ...
  public async documentsDocumentIdGet(
    ...
    const localVarPath =
      this.basePath +
      '/documents/{document_id}'.replace('{' + 'document_id' + '}', encodeURIComponent(String(documentId)))
   ...
   * @param documentId
   */
  public async getDocumentDownload(
    accountId: string,
    documentId: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body?: any }> {
  ...
  public async getDocuments(
    ...
    endDate?: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: Array<InlineResponse2003> }> {
    const localVarPath =
      this.basePath +
      '/accounts/{account_id}/documents'.replace('{' + 'account_id' + '}', encodeURIComponent(String(accountId)))
    const localVarQueryParameters: any = {}
    const localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders)
   ...
   */
  public async postDocumentUpload(
    accountId: string,
    documentUpload: Array<DocumentUpload>,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body?: any }> {
    const localVarPath =
      this.basePath +
      '/accounts/{account_id}/documents/upload'.replace('{' + 'account_id' + '}', encodeURIComponent(String(accountId)))
    const localVarQueryParameters: any = {}
    const localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders)
    const produces = ['application/json']
    // give precedence to 'application/json'
